			...
			<div class="modal-content">
				...
				<form method="post" action="addLibrarian"
					...
					<div class="modal-body">
						...
						<div class="form-row">
							...
							<div class="form-group col-md-6">
								<label for="addlpost">Post:</label> <select
									...
									<%
										Post[] post = Librarian.Post.values();
										for (Post p : post)
						...
						<div class="form-row">
							<div class="form-group col-md-12">
								<label for="addlCollege">College:</label> <select
									class="form-control custom-select" id="addlCollege"
									name="college">
									<%
		...
		<table class="table table-responsive-md">
			...
			<tr>
				<td colspan="3" class="text-center">
					<form action="delLibrarian" method="post">
						<div class="btn-group">
						...
						<div class="modal fade" id="<%=i%>" tabindex="-1" role="dialog"
							...
							<div class="modal-dialog" role="document">
								<div class="modal-content">
									...
									<form method="post" action="updateLibrarian" enctype="multipart/form-data">
										<div class="modal-body">
											...
											<div class="form-row">
												...
												<div class="form-group col-md-6">
													<label for="post">Post:</label> <select
														...
														<%
															post = Librarian.Post.values();
																	for (Post p : post) {
																		if (librarian.getPost().toString().equals(p.toString()))
											...
											<div class="form-row">
												<div class="form-group col-md-12">
													<label for="College">College:</label> <select
														class="form-control custom-select" id="College"
														name="college">
														<%
															colleges = (List<College>) request.getAttribute("colleges");
																	if (colleges != null)
																		for (College college : colleges) {
																			if (librarian.getCollege().getCode().equals(college.getCode()))
																				out.print("	<option value='" + college.getCode() + "' selected>" + college.getName()
																						+ "</option>");
																			else
																				out.print("	<option value='" + college.getCode() + "'>" + college.getName()
																						+ "</option>");
																		}
														%>
													</select>
